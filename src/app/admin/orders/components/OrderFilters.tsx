        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md leading-5 bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:placeholder:text-gray-500 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
            />
            {searchQuery && (
              <button
