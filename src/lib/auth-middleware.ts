...
// Create metadata for audit logs
export function getRequestMetadata(_request: NextRequest) {
  // Currently not extracting any request-specific metadata
  // Could be enhanced to include IP address, user agent, etc.
  return {
